...
export const Pagination = ({ pagination }) => {
  const { currentPage, totalProducts, totalPages, limit } = pagination;
  ...
  const barWidth = currentPage * limit;
  const paginationCurrent =
    totalProducts === limit
      ? totalProducts
      : barWidth < totalProducts
        ? barWidth
        : barWidth - limit + (totalProducts % limit);
    ...
    <div className={style.pagination}>
      <div className={style.bar}>
        <div
          ...
          style={{
            width: `calc(${
              barWidth < totalProducts ? barWidth : totalProducts
            } / ${totalProducts} * 100%)`,
          }}></div>
      </div>
